...
var districtsFile = 'data/qrySumStatsAllDistAllYears_2020_v2.csv';
var chartersFile  = 'data/qrySumStatsAllCharterDistAllYears_2020_v2.csv';
...
function drawChart() {
	if (chartData.visible) {
		...
		g.append("text")
			...
			.attr("y", 15-margin.left).attr("dy", "1ex")
